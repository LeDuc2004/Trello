...
// console.log(Object.keys(listColumn.tasks).length);
  ...
  function AddColumn() {
    if (textClumn) {
      getData(`/dataTable/${stores.id}`).then((data) => {
        ...
        putData(`/dataTable/${stores.id}`, newColumn).then((res) => handleVisibleAddColumn() );
      });
    }
  }
    ...
    >
      <div className={`todo-slideBar ${slidebarToTodos ? "fullscreen" : ""}`}>
        <div className="todo-slideBar__left">
          ...
          <div className="todo-slideBar__table curent">
            <i
              style={{ rotate: "180deg" }}
          ...
          <div className="todo-slideBar__table">
